...
type StorageObject struct {
	...
	// particular object.
	Metageneration string `protobuf:"bytes,6,opt,name=metageneration,proto3" json:"metageneration,omitempty"`
	...
	// Attempting to set this field will result in an error.
	Generation string `protobuf:"bytes,26,opt,name=generation,proto3" json:"generation,omitempty"`
...
func (x *StorageObject) GetMetageneration() string {
	if x != nil {
...
func (x *StorageObject) GetSize() string {
	if x != nil {
		return x.Size
	}
	return ""
...
func (x *StorageObject) GetGeneration() string {
	if x != nil {
		return x.Generation
	}
	return ""
...
var file_cloud_storage_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x0e, 0x6d, 0x65, 0x74, 0x61, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f,
	...
	0x09, 0x52, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x12, 0x3d, 0x0a, 0x0c, 0x74, 0x69, 0x6d, 0x65, 0x5f,
	...
	0x6c, 0x61, 0x62, 0x73, 0x2f, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2f, 0x67, 0x63, 0x70, 0x3b, 0x67,
